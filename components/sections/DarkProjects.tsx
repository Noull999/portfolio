      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="md:hidden -mx-6 flex snap-x snap-mandatory gap-3 overflow-x-auto px-6 pb-4">
          {PROJECTS.map((project, i) => (
            <div
              key={project.id + '-m'}
              className="w-[82vw] flex-none snap-center rounded-xl border"
              style={{ borderColor: 'var(--border)' }}
            >
        ...
        {/* Desktop: grid */}
        <div
          className="hidden md:grid md:grid-cols-2 md:gap-px md:overflow-hidden md:rounded-xl md:border lg:grid-cols-3"
